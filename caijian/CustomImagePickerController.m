...
- (void)viewDidLoad
{
   ...
   // self.navigationController.navigationBar.backgroundColor = [z_UI colorWithHexString:@"#2786CB"];
}
...
didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    image = [[image clipImageWithScaleWithsize:CGSizeMake(image.size.width, image.size.height)] retain] ;

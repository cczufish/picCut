...
- (void)viewDidLoad
{
    ...
    self.navBar.rightNavButton.hidden = NO;
    [self.navBar.rightNavButton setTitle:@"保存" forState:UIControlStateNormal];
    [self.navBar.rightNavButton addTarget:self action:@selector(saveTapped) forControlEvents:UIControlEventTouchUpInside];
    
    [self.navBar.backToParentBtn addTarget:self action:@selector(cancelTapped) forControlEvents:UIControlEventTouchUpInside];
